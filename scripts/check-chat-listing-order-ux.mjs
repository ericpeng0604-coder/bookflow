...
const checks = [
  ...
  ["member center exposes combined order tracking tab", app.includes('dashboardTab === "tracking"') && app.includes("trackedOrders.map") && app.includes("交易追蹤") && app.includes("orderTrackingNote")],
