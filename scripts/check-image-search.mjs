...
assert.match(app, /BookFlow 站內刊登/, "UI must disclose that photo search is site-local");
...
const candidateFunction = queries.match(/export async function fetchImageSearchCandidates[\s\S]*?\n}\n\nexport async function fetchBookById/)?.[0] ?? "";
