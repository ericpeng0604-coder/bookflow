...
const checks = [
  ...
  ["mobile hero search arrow", homeBlock.includes('className="hero-search-arrow"') && homeBlock.includes('aria-label={isSecondhandMode ?') && homeBlock.includes("依目前輸入開始找二手物品") && globalCss.includes(".hero-search-arrow")],
  ...
  ["market switch and dynamic hero message", app.includes('className="market-switch"') && homeBlock.includes("Good Finds,") && homeBlock.includes("Used Books,")],
