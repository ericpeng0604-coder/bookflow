...
BookFlow admin moderation workbench release 0.1.6

## 目前狀態與背景

- Task ID: `20260722-admin-workbench-release`.
- Task: `BookFlow admin moderation workbench release 0.1.6`.
- Branch: `codex/repair-admin-workbench`.
- Base commit: `178cd7d92dc6ae6b531add59aeed00cac47b6189`.
- History: `.ai/history/20260722-admin-workbench-release.md`.
...
- Restore the latest admin moderation workbench with workspace navigation, overview cards, listing review table, and detail drawer.
- Bump the application patch version from 0.1.5 to 0.1.6.
...
- Admin workbench checks passed 8/8; risk warning checks passed 23/23; TypeScript and production build passed.
...
- Base commit: `178cd7d92dc6ae6b531add59aeed00cac47b6189`.
- Current implementation commit: pending release commit.
